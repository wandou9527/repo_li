...
cd /Users/liming/Documents/java/java_self/git_site_self/repo_li/mouse0823c
echo 'git pull ...'
git pull
echo 'mvn clean package ...'
mvn clean package -Dmaven.test.skip=true
echo '进入 target 目录'
cd /Users/liming/Documents/java/java_self/git_site_self/repo_li/mouse0823c/target
echo 'run java -jar 。。。'
