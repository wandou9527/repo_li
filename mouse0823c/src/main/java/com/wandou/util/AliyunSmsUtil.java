...
import com.wandou.model.dto.SmsTemplateParamDTO;
...
public class AliyunSmsUtil {
    ...
    public static SendSmsResponse sendSms(String phone,
        ...
        SmsTemplateParamDTO smsTemplateParamDTO = new SmsTemplateParamDTO();
        smsTemplateParamDTO.setName(name);
        smsTemplateParamDTO.setCode(code);
        smsTemplateParamDTO.setContent(content);
        //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
        request.setTemplateParam(JSON.toJSONString(smsTemplateParamDTO));
    ...
    public static QuerySendDetailsResponse querySendDetails(String bizId) throws ClientException {
        ...
        //必填-号码
        request.setPhoneNumber("13693140755");
        //可选-流水号
    ...
    public static void main(String[] args) throws ClientException, InterruptedException {
        ...
        //发短信
        SendSmsResponse response = sendSms("13693140755",
                "limi",
                GenUtil.genCode(4),
                "几年几个月",
                "",
